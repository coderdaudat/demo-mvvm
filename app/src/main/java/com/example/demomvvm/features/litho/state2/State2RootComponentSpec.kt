...
@LayoutSpec
object State2RootComponentSpec {
                ...
                Row.create(c)
                    ...
                    .child(
                        Text.create(c)
                            ...
                            .clickHandler(State2RootComponent.onDecrement(c))
                            .build()
                    )
                    .child(
                        Text.create(c)
                    ...
                    .child(
                        Text.create(c)
                            ...
                            .clickHandler(State2RootComponent.onIncrement(c))
                    )
            )
            .child(
                Row.create(c)
                    ...
                    .child(
                        TextInput.create(c)
                            ...
                            .textChangedEventHandler(State2RootComponent.onChangeStep(c))
                    )
            )
            .build()
    }
    ...
    fun onDecrement(c: ComponentContext) {
        State2RootComponent.decrement(c) // Call the decrement state update method.
    }
    ...
    fun onIncrement(c: ComponentContext) {
        State2RootComponent.increment(c) // Call the increment state update method.
    }
    ...
    fun onChangeStep(c: ComponentContext, @FromEvent text: String) {
        ...
        */
        State2RootComponent.lazyUpdateStep(c, value)
    }
